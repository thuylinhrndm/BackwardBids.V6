...
public class NVPAPICaller
{
    ...
    public string APIUsername = "albahri301993-facilitator_api1.gmail.com";
    private string APIPassword = "WD3XECAYESAZPMSF";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AZ7J.tkgpNg3JEl5nKuhKwGeFeDr";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["BRANDNAME"] = "BackwardsBid";
        ...
        using (BackwardsBid.Logic.ShoppingCartActions myCartOrders = new BackwardsBid.Logic.ShoppingCartActions())
        {
